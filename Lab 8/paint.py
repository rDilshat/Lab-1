...
#Surface for instruments and colors
...
#Dictionary with colors in RGB format
colors = {"red": (255, 0, 0), "green": (0, 255, 0), "blue": (0, 0, 255)}
current_color = 'red' #Current color

#Dictionary with modes of painting
modes = {'rect':rect, 'circle':circle, 'eraser':eraser}
current_mode = 'rect' #Current mode
